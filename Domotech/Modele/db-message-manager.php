...
$reponse = $db->prepare('SELECT messageint.ID ID , messageint.objet objet , messageint.message message , utilisateurs.identifiant nom , lu , messageint.date datee FROM `messageint`
